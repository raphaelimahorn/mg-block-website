...
test('Event', () => {
    ...
    desc('Constructor uses defaults if necessary', () => {
        ...
        it('tenu', () => Assert.isEqual(new Event(minimalEvent).tenu, 'none'));
    });
    ...
    desc('Constructor calculates calculated values correctly', () => {
        ...
        ['a', 'A', 'tenu a', 'tenua'].it('tenu of a', tenu => Assert.isEqual(new Event({...minimalEvent, tenu}).tenu, 'a'));
        ['b', 'B', 'tenu b', 'tenub'].it('tenu of b', tenu => Assert.isEqual(new Event({...minimalEvent, tenu}).tenu, 'b'));
        ['cps', 'off', 'hochoff', 'farben'].it('tenu of cps', tenu => Assert.isEqual(new Event({...minimalEvent, tenu}).tenu, 'cps'));
        [undefined, 'none', 'x', 'some stuff'].it('tenu of none', tenu => Assert.isEqual(new Event({...minimalEvent, tenu}).tenu, 'none'));
    });
});